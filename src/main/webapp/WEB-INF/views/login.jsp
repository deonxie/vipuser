        ...
        <form id="loginForm"  class="form login-form" action="${ctx}/login" method="post">
            ...
            <div class="body">
                <div class="control-group">
                    <div class="controls">
                        <input type="text" id="username" name="username" class="required" value="${username}" placeholder="用户名">
                    </div>
                </div>
...
<!-- <footer class="transparent navbar-fixed-bottom">
    Copyright &copy; 2012-2014 - Powered By <a href="#" target="_blank"></a>
</footer> -->
</body>
</html>